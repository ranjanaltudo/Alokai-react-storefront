...
export default function FooterBasic() {
  return (
    <footer className="pt-10 bg-neutral-100">
      ...
      <hr />
      <div className="py-10 md:flex md:mx-auto max-w-full">
      ...
      <div className="bg-neutral-900 justify-end px-4 py-10 md:flex md:py-6 max-w-full mx-auto">
