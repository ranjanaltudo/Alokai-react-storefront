...
let a = s;
var u = (a.__esModule ? a : { default: a }).default;
const d = /* @__PURE__ */ h(u), r = "sfTypography", c = d.withOptions(
  ({ utilityPrefix: e = "typography" } = {}) => function({ matchUtilities: n, theme: l }) {
    n(
      {
        [e]: (t) => {
          if (Array.isArray(t.fontSize)) {
            const i = t.fontSize[1];
            i && (t = {
              ...typeof i == "object" ? i : { lineHeight: i },
              ...t
