...
var require_jw_paginate = __commonJS({
  "node_modules/jw-paginate/lib/jw-paginate.js"(exports, module) {
    ...
    function paginate(totalItems, currentPage, pageSize, maxPages) {
      ...
      var pages = Array.from(Array(endPage + 1 - startPage).keys()).map(function(i15) {
        return startPage + i15;
      });
      return {
        totalItems,
        currentPage,
...
var k = (0, import_react.forwardRef)((i15, t28) => {
  const { open: s10, onToggle: e12, children: o35, summary: r13, summaryClassName: a32, ...l20 } = i15;
  return (0, import_jsx_runtime.jsxs)("details", { ref: t28, open: s10, "data-testid": "accordion-item", ...l20, children: [
    (0, import_jsx_runtime.jsx)(
      "summary",
      {
        onClick: (n27) => {
          n27.preventDefault(), e12 == null || e12(!s10);
        },
...
var f = import_react2.forwardRef;
...
var v = (r13, e12) => {
  switch (r13) {
    case j.sm:
      return [e12 ? "p-1.5" : "leading-5 text-sm py-1.5 px-3", "gap-1.5"];
    case j.lg:
      return [e12 ? "p-4" : "py-3 leading-6 px-6", "gap-3"];
    default:
      return [e12 ? "p-2" : "py-2 leading-6 px-4", "gap-2"];
  }
};
var z2 = f((r13, e12) => {
  const {
...
function b({
  ...
  variant: s10,
  max: r13 = 99,
  placement: t28 = Y["top-right"],
  className: l20,
  ...i15
}) {
  const e12 = s10 === "dot";
  let o35 = a32;
  return e12 ? o35 = "" : !Number.isNaN(a32) && Number(a32) > r13 && (o35 = `${r13}+`), (0, import_jsx_runtime3.jsx)(
    "span",
    {
      className: (0, import_classnames3.default)(
        "block absolute py-0.5 px-1 bg-secondary-700 font-medium text-white text-[8px] leading-[8px] rounded-xl",
        {
          ...
          "w-[10px] h-[10px]": e12,
          "top-0 right-0 -translate-x-0.5 translate-y-0.5": t28 === "top-right",
          "top-0 left-0 translate-x-0.5 translate-y-0.5": t28 === "top-left",
          "bottom-0 right-0 -translate-x-0.5 -translate-y-0.5": t28 === "bottom-right",
          "bottom-0 left-0 translate-x-0.5 -translate-y-0.5": t28 === "bottom-left"
        },
        l20
      ),
      "data-testid": "badge",
...
var l = (0, import_react3.forwardRef)(
  ({ invalid: e12, className: r13, ...t28 }, a32) => (0, import_jsx_runtime4.jsx)(
    "input",
    {
...
var x2 = (e12, r13, i15, n27) => {
  switch (e12) {
    case C.sm:
      return r13 ? "px-1.5" : [i15 ? "pl-1.5" : "pl-3", n27 ? "pr-1.5" : "pr-3"];
    default:
      return r13 ? "px-2" : [i15 ? "pl-2" : "pl-4", n27 ? "pr-2" : "pr-4"];
  }
};
var y2 = (e12) => {
  switch (e12) {
...
var j2 = (0, import_react4.forwardRef)(
  ({
    children: e12,
    size: r13 = C.base,
    className: i15,
    ...
    const s10 = (0, import_react4.useId)();
...
function d4({
  ...
  const a32 = {
    [U["3xs"]]: (0, import_classnames6.default)("text-3xs", { "px-1": e12 }),
    [U["2xs"]]: (0, import_classnames6.default)("text-2xs", { "px-1.5": e12 }),
    [U.xs]: (0, import_classnames6.default)("text-xs", { "px-2": e12 }),
    [U.sm]: (0, import_classnames6.default)("text-sm", { "px-2.5": e12 }),
    [U.base]: (0, import_classnames6.default)("text-base", { "px-3": e12 }),
    [U.lg]: (0, import_classnames6.default)("text-lg", { "px-3.5": e12 })
  }, f15 = (0, import_classnames6.default)([
  ...
  return (0, import_jsx_runtime6.jsx)("span", { className: f15, "data-testid": "counter", ...x6, children: o35 });
}
...
function o3(e12) {
  return (t28) => {
    e12.forEach((n27) => {
      typeof n27 == "function" ? n27(t28) : n27 != null && (n27.current = t28);
    });
  };
}
...
var F = f(
  ({
    as: r13,
    open: m25,
    placement: a32 = A.left,
    disableClickAway: i15,
    disableEsc: o35,
    onClose: t28,
    className: s10,
    children: p10,
    ...
    const w4 = r13 || h3, e12 = (0, import_react5.useRef)(null);
    useClickAway_default(e12, () => {
      i15 || t28 == null || t28();
    });
    const u9 = (g7) => {
      o35 || g7.key === "Escape" && (t28 == null || t28());
    };
    return m25 ? (0, import_jsx_runtime7.jsx)(
      w4,
      {
        ref: o3([e12, d12]),
        className: (0, import_classnames7.default)("fixed", k2(a32), s10),
        tabIndex: "-1",
        "data-testid": "drawer",
        ...c21,
        onKeyDown: u9,
  ...
  return {
    ...
    async fn(state) {
      ...
      if (!overflows.every((side2) => side2 <= 0)) {
        ...
        let resetPlacement = (_overflowsData$filter = overflowsData.filter((d12) => d12.overflows[0] <= 0).sort((a32, b8) => a32.overflows[1] - b8.overflows[1])[0]) == null ? void 0 : _overflowsData$filter.placement;
        if (!resetPlacement) {
          switch (fallbackStrategy) {
            case "bestFit": {
              ...
              const placement2 = (_overflowsData$filter2 = overflowsData.filter((d12) => {
                ...
                return true;
              }).map((d12) => [d12.placement, d12.overflows.filter((overflow2) => overflow2 > 0).reduce((acc, overflow2) => acc + overflow2, 0)]).sort((a32, b8) => a32[1] - b8[1])[0]) == null ? void 0 : _overflowsData$filter2[0];
              if (placement2) {
...
function getScale(element) {
  ...
  let y6 = ($3 ? round(rect.height) : rect.height) / height;
...
function rectsAreEqual(a32, b8) {
  return a32.x === b8.x && a32.y === b8.y && a32.width === b8.width && a32.height === b8.height;
}
...
function deepEqual(a32, b8) {
  if (a32 === b8) {
    return true;
  }
  if (typeof a32 !== typeof b8) {
    return false;
  }
  if (typeof a32 === "function" && a32.toString() === b8.toString()) {
    return true;
  }
  let length;
  let i15;
  let keys;
  if (a32 && b8 && typeof a32 === "object") {
    if (Array.isArray(a32)) {
      length = a32.length;
      if (length !== b8.length)
        return false;
      for (i15 = length; i15-- !== 0; ) {
        if (!deepEqual(a32[i15], b8[i15])) {
          return false;
        }
      }
      return true;
    }
    keys = Object.keys(a32);
    length = keys.length;
    if (length !== Object.keys(b8).length) {
      return false;
    }
    for (i15 = length; i15-- !== 0; ) {
      if (!{}.hasOwnProperty.call(b8, keys[i15])) {
        return false;
      }
    }
    for (i15 = length; i15-- !== 0; ) {
      const key = keys[i15];
      if (key === "_owner" && a32.$$typeof) {
        continue;
      }
      if (!deepEqual(a32[key], b8[key])) {
        return false;
      }
    }
    return true;
  }
  return a32 !== a32 && b8 !== b8;
}
...
function P2(t28) {
  const {
    isOpen: e12,
    middleware: o35,
    placement: r13 = S.bottom,
    strategy: a32 = tt.absolute
  } = t28, { refs: n27, strategy: s10, x: i15, y: l20, middlewareData: p10 } = useFloating({
    strategy: a32,
    placement: r13,
    open: e12,
    middleware: o35,
...
function C2(r13) {
  const {
    ...
    middleware: n27 = [offset3(8), shift3(), flip3()],
    ...p10
  } = r13, { refs: e12, style: f15 } = P2({ placement: s10, middleware: n27, ...p10 });
  return useClickAway_default(e12.reference, o35), useKey_default("Escape", o35, { target: e12.reference.current }, t28), { refs: e12, style: f15 };
}

// node_modules/@storefront-ui/react/dist/components/SfDropdown/SfDropdown.mjs
function u4(o35) {
  const { children: s10, trigger: r13, open: e12 = false, className: n27, style: d12, ...a32 } = o35, { refs: t28, style: i15 } = C2({ isOpen: e12, ...a32 });
  return (0, import_jsx_runtime8.jsxs)(
    "div",
    {
      ref: t28.setReference,
      className: (0, import_classnames8.default)("w-max", n27),
      style: d12,
      "data-testid": "dropdown",
      children: [
        r13,
        e12 && (0, import_jsx_runtime8.jsx)("div", { ref: t28.setFloating, style: i15, "aria-hidden": !e12, "data-testid": "dropdown-content", children: s10 })
      ]
    }
  );
}
...
function h4({
  ...
  return (0, import_jsx_runtime9.jsx)(
    "svg",
    {
      ...
      className: (0, import_classnames9.default)("inline-block fill-current", l3(r13), s10),
      ...n27,
      children: t28
    }
  );
...
function n2({ size: o35 = q.base, viewBox: t28 = "0 0 24 24", ...r13 }) {
  return (0, import_jsx_runtime10.jsx)(h4, { size: o35, viewBox: t28, "data-testid": "add", ...r13, children: (0, import_jsx_runtime10.jsx)("path", { d: "M12 19a.97.97 0 0 1-.712-.288A.97.97 0 0 1 11 18v-5H6a.97.97 0 0 1-.713-.288A.97.97 0 0 1 5 12a.97.97 0 0 1 .287-.713A.97.97 0 0 1 6 11h5V6q0-.425.288-.713A.97.97 0 0 1 12 5a.97.97 0 0 1 .713.287A.97.97 0 0 1 13 6v5h5q.424 0 .712.287.288.288.288.713 0 .424-.288.712A.97.97 0 0 1 18 13h-5v5q0 .424-.287.712A.97.97 0 0 1 12 19" }) });
}
...
function l4({
  ...
  return (0, import_jsx_runtime15.jsx)(h4, { size: o35, viewBox: a32, "data-testid": "arrow-downward", ...t28, children: (0, import_jsx_runtime15.jsx)("path", { d: "M12 19.575a1.1 1.1 0 0 1-.375-.063.9.9 0 0 1-.325-.212l-6.6-6.6q-.3-.3-.3-.713 0-.412.3-.712t.7-.3.7.3l4.9 4.9v-11.2q0-.425.288-.7A1 1 0 0 1 12 4a.97.97 0 0 1 .713.287A.97.97 0 0 1 13 5v11.175l4.9-4.9q.3-.3.7-.3t.7.3.3.712q0 .413-.3.713l-6.6 6.6q-.15.15-.325.212a1.1 1.1 0 0 1-.375.063" }) });
}
...
function l5({
  size: a32 = q.base,
  viewBox: o35 = "0 0 24 24",
  ...t28
}) {
  return (0, import_jsx_runtime16.jsx)(h4, { size: a32, viewBox: o35, "data-testid": "arrow-forward", ...t28, children: (0, import_jsx_runtime16.jsx)("path", { d: "M11.3 19.3a1 1 0 0 1-.288-.7.9.9 0 0 1 .263-.7l4.9-4.9H5a.97.97 0 0 1-.713-.288A.97.97 0 0 1 4 12a.97.97 0 0 1 .287-.713A.97.97 0 0 1 5 11h11.175l-4.9-4.9a.9.9 0 0 1-.263-.7 1 1 0 0 1 .288-.7.95.95 0 0 1 .7-.275q.425 0 .7.275l6.6 6.6q.15.125.213.312.062.188.062.388t-.062.375a.9.9 0 0 1-.213.325l-6.6 6.6a.95.95 0 0 1-.7.275.95.95 0 0 1-.7-.275" }) });
}
...
function p3({
  ...
  return (0, import_jsx_runtime17.jsx)(h4, { size: a32, viewBox: o35, "data-testid": "arrow-upward", ...t28, children: (0, import_jsx_runtime17.jsx)("path", { d: "M12 20a.97.97 0 0 1-.712-.288A.97.97 0 0 1 11 19V7.825L6.125 12.7q-.3.3-.713.3a.97.97 0 0 1-.712-.3.96.96 0 0 1-.3-.7q0-.4.3-.7l6.6-6.6q.15-.15.325-.213.175-.062.375-.062t.388.062a.7.7 0 0 1 .312.213l6.6 6.6q.3.3.3.7t-.3.7-.713.3a.97.97 0 0 1-.712-.3L13 7.825V19q0 .424-.287.712A.97.97 0 0 1 12 20" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconBlock.mjs
var import_jsx_runtime18 = __toESM(require_jsx_runtime(), 1);
function i2({ size: a32 = q.base, viewBox: q4 = "0 0 24 24", ...t28 }) {
  return (0, import_jsx_runtime18.jsx)(h4, { size: a32, viewBox: q4, "data-testid": "block", ...t28, children: (0, import_jsx_runtime18.jsx)("path", { d: "M12 22a9.7 9.7 0 0 1-3.9-.788 10.1 10.1 0 0 1-3.175-2.137q-1.35-1.35-2.137-3.175A9.7 9.7 0 0 1 2 12q0-2.075.788-3.9a10.1 10.1 0 0 1 2.137-3.175q1.35-1.35 3.175-2.138A9.7 9.7 0 0 1 12 2q2.075 0 3.9.787a10.1 10.1 0 0 1 3.175 2.138q1.35 1.35 2.137 3.175A9.7 9.7 0 0 1 22 12a9.7 9.7 0 0 1-.788 3.9 10.1 10.1 0 0 1-2.137 3.175q-1.35 1.35-3.175 2.137A9.7 9.7 0 0 1 12 22m0-2q3.35 0 5.675-2.325T20 12q0-1.35-.438-2.6A8 8 0 0 0 18.3 7.1L7.1 18.3q1.05.825 2.3 1.262T12 20m-6.3-3.1L16.9 5.7q-1.05-.824-2.3-1.262A7.8 7.8 0 0 0 12 4Q8.65 4 6.325 6.325T4 12q0 1.35.438 2.6.437 1.25 1.262 2.3" }) });
}
...
function m5({
  size: o35 = q.base,
  viewBox: r13 = "0 0 24 24",
  ...t28
}) {
  return (0, import_jsx_runtime19.jsx)(h4, { size: o35, viewBox: r13, "data-testid": "calendar-today", ...t28, children: (0, import_jsx_runtime19.jsx)("path", { d: "M5 22q-.825 0-1.413-.587A1.93 1.93 0 0 1 3 20V6q0-.824.587-1.412A1.93 1.93 0 0 1 5 4h1V2.975q0-.425.287-.7A1 1 0 0 1 7 2a.97.97 0 0 1 .713.287A.97.97 0 0 1 8 3v1h8V2.975q0-.425.288-.7A1 1 0 0 1 17 2q.424 0 .712.287Q18 2.575 18 3v1h1q.825 0 1.413.588Q21 5.175 21 6v14q0 .825-.587 1.413A1.93 1.93 0 0 1 19 22zm0-2h14V10H5z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconCall.mjs
var import_jsx_runtime20 = __toESM(require_jsx_runtime(), 1);
function n5({ size: a32 = q.base, viewBox: l20 = "0 0 24 24", ...o35 }) {
  return (0, import_jsx_runtime20.jsx)(h4, { size: a32, viewBox: l20, "data-testid": "call", ...o35, children: (0, import_jsx_runtime20.jsx)("path", { d: "M19.95 21q-3.225 0-6.287-1.438a19 19 0 0 1-5.425-3.8 19 19 0 0 1-3.8-5.425Q3 7.275 3 4.05q0-.45.3-.75t.75-.3H8.1a.96.96 0 0 1 .625.225.88.88 0 0 1 .325.575l.65 3.5q.05.35-.012.637a1.03 1.03 0 0 1-.288.513L6.975 10.9q1.05 1.8 2.638 3.375A18.6 18.6 0 0 0 13.1 17l2.35-2.35q.225-.225.588-.338.362-.112.712-.062l3.45.7q.35.075.575.337.225.263.225.613v4.05q0 .45-.3.75t-.75.3M6.025 9l1.65-1.65L7.25 5H5.025q.125 1.024.35 2.025T6.025 9M19 18.95v-2.2l-2.35-.475-1.675 1.675q.975.424 1.988.675 1.012.25 2.037.325" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconCancel.mjs
var import_jsx_runtime21 = __toESM(require_jsx_runtime(), 1);
function f4({ size: a32 = q.base, viewBox: o35 = "0 0 24 24", ...l20 }) {
  return (0, import_jsx_runtime21.jsx)(h4, { size: a32, viewBox: o35, "data-testid": "cancel", ...l20, children: (0, import_jsx_runtime21.jsx)(
    "path",
    {
      fillRule: "evenodd",
...
function m6({ size: t28 = q.base, viewBox: a32 = "0 0 24 24", ...e12 }) {
  return (0, import_jsx_runtime22.jsx)(h4, { size: t28, viewBox: a32, "data-testid": "check", ...e12, children: (0, import_jsx_runtime22.jsx)("path", { d: "M4.535 12.705 8 16.17l9.885-9.875a.997.997 0 0 1 1.41 1.41L8.707 18.293a1 1 0 0 1-1.414 0L3.12 14.12a1 1 0 0 1 1.415-1.415" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconCheckBox.mjs
var import_jsx_runtime23 = __toESM(require_jsx_runtime(), 1);
function m7({ size: a32 = q.base, viewBox: t28 = "0 0 24 24", ...e12 }) {
  return (0, import_jsx_runtime23.jsx)(h4, { size: a32, viewBox: t28, "data-testid": "check-box", ...e12, children: (0, import_jsx_runtime23.jsx)("path", { d: "M5 21q-.825 0-1.413-.587A1.93 1.93 0 0 1 3 19V5q0-.825.587-1.413A1.93 1.93 0 0 1 5 3h14q.825 0 1.413.587Q21 4.175 21 5v14q0 .825-.587 1.413A1.93 1.93 0 0 1 19 21zm5.6-5.225q.2 0 .375-.062a.9.9 0 0 0 .325-.213l5.675-5.675a.92.92 0 0 0 .275-.675q0-.4-.3-.7a.95.95 0 0 0-.7-.275.95.95 0 0 0-.7.275L10.6 13.4l-2.175-2.175a.92.92 0 0 0-.675-.275q-.4 0-.7.3a.95.95 0 0 0-.275.7q0 .425.275.7L9.9 15.5q.15.15.325.213.175.062.375.062" }) });
}
...
function d5({
  ...
  return (0, import_jsx_runtime24.jsx)(h4, { size: a32, viewBox: o35, "data-testid": "check-box-outline-blank", ...n27, children: (0, import_jsx_runtime24.jsx)(
    "path",
    {
      fillRule: "evenodd",
...
function m8({
  ...
  return (0, import_jsx_runtime25.jsx)(h4, { size: e12, viewBox: r13, "data-testid": "check-circle", ...c21, children: (0, import_jsx_runtime25.jsx)("path", { d: "m10.6 13.8-2.175-2.175a.92.92 0 0 0-.675-.275q-.4 0-.7.3a.95.95 0 0 0-.275.7q0 .425.275.7L9.9 15.9a.95.95 0 0 0 .7.275.95.95 0 0 0 .7-.275l5.675-5.675a.92.92 0 0 0 .275-.675q0-.4-.3-.7a.95.95 0 0 0-.7-.275.95.95 0 0 0-.7.275zM12 22a9.7 9.7 0 0 1-3.9-.788 10.1 10.1 0 0 1-3.175-2.137q-1.35-1.35-2.137-3.175A9.7 9.7 0 0 1 2 12q0-2.075.788-3.9a10.1 10.1 0 0 1 2.137-3.175q1.35-1.35 3.175-2.138A9.7 9.7 0 0 1 12 2q2.075 0 3.9.787a10.1 10.1 0 0 1 3.175 2.138q1.35 1.35 2.137 3.175A9.7 9.7 0 0 1 22 12a9.7 9.7 0 0 1-.788 3.9 10.1 10.1 0 0 1-2.137 3.175q-1.35 1.35-3.175 2.137A9.7 9.7 0 0 1 12 22" }) });
}
...
function l6({
  ...
  return (0, import_jsx_runtime26.jsx)(h4, { size: t28, viewBox: e12, "data-testid": "chevron-left", ...r13, children: (0, import_jsx_runtime26.jsx)("path", { d: "M14.706 17.297a1 1 0 0 0 0-1.41l-3.876-3.885 3.877-3.885a.998.998 0 0 0-1.412-1.41l-4.588 4.588a1 1 0 0 0 0 1.414l4.588 4.588a.997.997 0 0 0 1.41 0" }) });
}
...
function h5({
  ...
  return (0, import_jsx_runtime27.jsx)(h4, { size: r13, viewBox: t28, "data-testid": "chevron-right", ...a32, children: (0, import_jsx_runtime27.jsx)("path", { d: "M8.705 17.297a1 1 0 0 1-.001-1.41l3.876-3.885-3.876-3.885a.998.998 0 0 1 1.412-1.41l4.587 4.588a1 1 0 0 1 0 1.414l-4.587 4.588a.997.997 0 0 1-1.411 0" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconCircle.mjs
var import_jsx_runtime28 = __toESM(require_jsx_runtime(), 1);
function m9({ size: o35 = q.base, viewBox: t28 = "0 0 24 24", ...e12 }) {
  return (0, import_jsx_runtime28.jsx)(h4, { size: o35, viewBox: t28, "data-testid": "circle", ...e12, children: (0, import_jsx_runtime28.jsx)("path", { d: "M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconClose.mjs
var import_jsx_runtime29 = __toESM(require_jsx_runtime(), 1);
function s({ size: a32 = q.base, viewBox: t28 = "0 0 24 24", ...e12 }) {
  return (0, import_jsx_runtime29.jsx)(h4, { size: a32, viewBox: t28, "data-testid": "close", ...e12, children: (0, import_jsx_runtime29.jsx)("path", { d: "M18.295 5.705a1 1 0 0 1 0 1.41L13.41 12l4.885 4.885a.997.997 0 1 1-1.41 1.41L12 13.41l-4.885 4.885a.997.997 0 1 1-1.41-1.41L10.59 12 5.705 7.115a.997.997 0 0 1 1.41-1.41L12 10.59l4.885-4.885a.997.997 0 0 1 1.41 0" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconCloseSm.mjs
var import_jsx_runtime30 = __toESM(require_jsx_runtime(), 1);
function n6({ size: o35 = q.base, viewBox: a32 = "0 0 24 24", ...l20 }) {
  return (0, import_jsx_runtime30.jsx)(h4, { size: o35, viewBox: a32, "data-testid": "close-sm", ...l20, children: (0, import_jsx_runtime30.jsx)(
    "path",
    {
      fillRule: "evenodd",
...
function m10({
  size: t28 = q.base,
  viewBox: c21 = "0 0 24 24",
  ...o35
}) {
  return (0, import_jsx_runtime33.jsx)(h4, { size: t28, viewBox: c21, "data-testid": "credit-card", ...o35, children: (0, import_jsx_runtime33.jsx)("path", { d: "M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2m0 14H4v-6h16zm0-10H4V6h16z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconDelete.mjs
var import_jsx_runtime34 = __toESM(require_jsx_runtime(), 1);
function n8({ size: A6 = q.base, viewBox: e12 = "0 0 24 24", ...t28 }) {
  return (0, import_jsx_runtime34.jsx)(h4, { size: A6, viewBox: e12, "data-testid": "delete", ...t28, children: (0, import_jsx_runtime34.jsx)("path", { d: "M7 20q-.824 0-1.412-.587A1.93 1.93 0 0 1 5 18V5a.97.97 0 0 1-.713-.287A.97.97 0 0 1 4 4a.97.97 0 0 1 .287-.713A.97.97 0 0 1 5 3h4q0-.425.288-.713A.97.97 0 0 1 10 2h4a.97.97 0 0 1 .713.287A.97.97 0 0 1 15 3h4q.424 0 .712.287Q20 3.575 20 4a.97.97 0 0 1-.288.713A.97.97 0 0 1 19 5v13q0 .825-.587 1.413A1.93 1.93 0 0 1 17 20zM7 5v13h10V5zm2 10q0 .424.288.712A.97.97 0 0 0 10 16a.97.97 0 0 0 .713-.288A.97.97 0 0 0 11 15V8a.97.97 0 0 0-.287-.713A.97.97 0 0 0 10 7a.97.97 0 0 0-.712.287A.97.97 0 0 0 9 8zm4 0q0 .424.288.712A.97.97 0 0 0 14 16a.97.97 0 0 0 .713-.288A.97.97 0 0 0 15 15V8a.97.97 0 0 0-.287-.713A.97.97 0 0 0 14 7a.97.97 0 0 0-.712.287A.97.97 0 0 0 13 8z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconDownload.mjs
var import_jsx_runtime35 = __toESM(require_jsx_runtime(), 1);
function i3({ size: o35 = q.base, viewBox: q4 = "0 0 24 24", ...t28 }) {
  return (0, import_jsx_runtime35.jsx)(h4, { size: o35, viewBox: q4, "data-testid": "download", ...t28, children: (0, import_jsx_runtime35.jsx)("path", { d: "M12 15.575q-.2 0-.375-.062a.9.9 0 0 1-.325-.213l-3.6-3.6a.92.92 0 0 1-.288-.7q.014-.4.288-.7.3-.3.712-.312a.93.93 0 0 1 .713.287L11 12.15V5q0-.424.287-.713A.97.97 0 0 1 12 4q.424 0 .713.287Q13 4.576 13 5v7.15l1.875-1.875a.93.93 0 0 1 .713-.287Q16 10 16.3 10.3q.276.3.287.7a.92.92 0 0 1-.287.7l-3.6 3.6q-.15.15-.325.212a1.1 1.1 0 0 1-.375.063M6 20q-.824 0-1.412-.587A1.93 1.93 0 0 1 4 18v-2q0-.424.287-.713A.97.97 0 0 1 5 15q.424 0 .713.287Q6 15.576 6 16v2h12v-2q0-.424.288-.713A.97.97 0 0 1 19 15q.424 0 .712.287.288.288.288.713v2q0 .824-.587 1.413A1.93 1.93 0 0 1 18 20z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconEmail.mjs
var import_jsx_runtime36 = __toESM(require_jsx_runtime(), 1);
function c5({ size: t28 = q.base, viewBox: a32 = "0 0 24 24", ...r13 }) {
  return (0, import_jsx_runtime36.jsx)(h4, { size: t28, viewBox: a32, "data-testid": "email", ...r13, children: (0, import_jsx_runtime36.jsx)("path", { d: "M4 20q-.824 0-1.412-.587A1.93 1.93 0 0 1 2 18V6q0-.824.587-1.412A1.93 1.93 0 0 1 4 4h16q.824 0 1.413.588Q22 5.175 22 6v12q0 .824-.587 1.413A1.93 1.93 0 0 1 20 20zM20 8l-7.475 4.675a1.04 1.04 0 0 1-.525.15 1.04 1.04 0 0 1-.525-.15L4 8v10h16zm-8 3 8-5H4zM4 8.25V6.775 6.8v-.013z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconError.mjs
var import_jsx_runtime37 = __toESM(require_jsx_runtime(), 1);
function c6({ size: e12 = q.base, viewBox: o35 = "0 0 24 24", ...a32 }) {
  return (0, import_jsx_runtime37.jsx)(h4, { size: e12, viewBox: o35, "data-testid": "error", ...a32, children: (0, import_jsx_runtime37.jsx)(
    "path",
    {
      fillRule: "evenodd",
...
function i4({
  ...
  return (0, import_jsx_runtime38.jsx)(h4, { size: e12, viewBox: o35, "data-testid": "expand-less", ...t28, children: (0, import_jsx_runtime38.jsx)("path", { d: "M17 15a1 1 0 0 1-1.41 0l-3.885-3.875L7.82 15a.998.998 0 0 1-1.41-1.412l4.588-4.587a1 1 0 0 1 1.414 0L17 13.589A1 1 0 0 1 17 15" }) });
}
...
function m11({
  ...
  return (0, import_jsx_runtime39.jsx)(h4, { size: o35, viewBox: r13, "data-testid": "expand-more", ...e12, children: (0, import_jsx_runtime39.jsx)("path", { d: "M17 9.003a1 1 0 0 0-1.41 0l-3.885 3.876L7.82 9.003a.998.998 0 0 0-1.41 1.411l4.588 4.588a1 1 0 0 0 1.414 0L17 10.414a.997.997 0 0 0 0-1.41" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconFacebook.mjs
var import_jsx_runtime40 = __toESM(require_jsx_runtime(), 1);
function n9({ size: t28 = q.base, viewBox: e12 = "0 0 24 24", ...r13 }) {
  return (0, import_jsx_runtime40.jsx)(h4, { size: t28, viewBox: e12, "data-testid": "facebook", ...r13, children: (0, import_jsx_runtime40.jsx)("path", { d: "m17.01 13.25.555-3.62h-3.473V7.282c0-.99.485-1.956 2.04-1.956h1.58V2.245S16.279 2 14.909 2c-2.86 0-4.73 1.734-4.73 4.872V9.63H7v3.62h3.18V22h3.912v-8.75z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconFavorite.mjs
var import_jsx_runtime41 = __toESM(require_jsx_runtime(), 1);
function l7({ size: o35 = q.base, viewBox: t28 = "0 0 24 24", ...r13 }) {
  return (0, import_jsx_runtime41.jsx)(h4, { size: o35, viewBox: t28, "data-testid": "favorite", ...r13, children: (0, import_jsx_runtime41.jsx)(
    "path",
    {
      fillRule: "evenodd",
...
function c7({
  ...
  return (0, import_jsx_runtime42.jsx)(h4, { size: t28, viewBox: e12, "data-testid": "favorite-filled", ...r13, children: (0, import_jsx_runtime42.jsx)("path", { d: "M10.67 21.133c-5.52-4.95-8.72-7.64-8.67-11.39.04-2.97 2.3-4.39 2.35-4.43 3.61-2.46 6.89.22 7.65 1.11.75-.88 3.99-3.51 7.56-1.16.52.34 2.23 1.65 2.42 4.12.32 4.28-4.14 7.76-8.65 11.76-.38.34-.86.5-1.34.5-.47 0-.94-.17-1.32-.51" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconGridView.mjs
var import_jsx_runtime43 = __toESM(require_jsx_runtime(), 1);
function v2({ size: h9 = q.base, viewBox: r13 = "0 0 24 24", ...A6 }) {
  return (0, import_jsx_runtime43.jsx)(h4, { size: h9, viewBox: r13, "data-testid": "grid-view", ...A6, children: (0, import_jsx_runtime43.jsx)("path", { d: "M5 11q-.825 0-1.413-.588A1.93 1.93 0 0 1 3 9V5q0-.825.587-1.413A1.93 1.93 0 0 1 5 3h4q.825 0 1.413.587Q11 4.175 11 5v4q0 .825-.587 1.412A1.93 1.93 0 0 1 9 11zm0 10q-.825 0-1.413-.587A1.93 1.93 0 0 1 3 19v-4q0-.825.587-1.413A1.93 1.93 0 0 1 5 13h4q.825 0 1.413.587Q11 14.175 11 15v4q0 .825-.587 1.413A1.93 1.93 0 0 1 9 21zm10-10q-.825 0-1.412-.588A1.92 1.92 0 0 1 13 9V5q0-.825.588-1.413A1.93 1.93 0 0 1 15 3h4q.825 0 1.413.587Q21 4.175 21 5v4q0 .825-.587 1.412A1.93 1.93 0 0 1 19 11zm0 10q-.825 0-1.412-.587A1.93 1.93 0 0 1 13 19v-4q0-.825.588-1.413A1.93 1.93 0 0 1 15 13h4q.825 0 1.413.587Q21 14.175 21 15v4q0 .825-.587 1.413A1.93 1.93 0 0 1 19 21zM5 9h4V5H5zm10 0h4V5h-4zm0 10h4v-4h-4zM5 19h4v-4H5z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconHelp.mjs
var import_jsx_runtime44 = __toESM(require_jsx_runtime(), 1);
function n10({ size: q4 = q.base, viewBox: t28 = "0 0 24 24", ...o35 }) {
  return (0, import_jsx_runtime44.jsx)(h4, { size: q4, viewBox: t28, "data-testid": "help", ...o35, children: (0, import_jsx_runtime44.jsx)("path", { d: "M11.95 18q.525 0 .888-.363.362-.362.362-.887t-.362-.887a1.2 1.2 0 0 0-.888-.363q-.525 0-.888.363a1.2 1.2 0 0 0-.362.887q0 .525.362.887.363.363.888.363m.15-10.3q.7 0 1.125.387.425.388.425 1.013 0 .424-.287.862a5 5 0 0 1-.813.913q-.75.65-1.1 1.25t-.35 1.2q0 .35.263.587A.904.904 0 0 0 12.6 13.9q.275-.25.35-.625.075-.425.338-.787.262-.363.862-.938.776-.725 1.088-1.325T15.55 8.9q0-1.275-.962-2.088Q13.625 6 12.1 6q-1.05 0-1.862.4a2.84 2.84 0 0 0-1.263 1.225 1 1 0 0 0-.125.637q.05.314.35.513a.97.97 0 0 0 .713.125 1 1 0 0 0 .637-.425q.274-.375.663-.575.387-.2.887-.2M12 22a9.7 9.7 0 0 1-3.875-.788 10.2 10.2 0 0 1-3.187-2.137 10 10 0 0 1-2.15-3.175A9.7 9.7 0 0 1 2 12q0-2.075.788-3.9a10 10 0 0 1 2.15-3.175Q6.3 3.575 8.125 2.787A9.7 9.7 0 0 1 12 2q2.1 0 3.925.787A10.1 10.1 0 0 1 19.1 4.925q1.35 1.35 2.125 3.175A9.9 9.9 0 0 1 22 12a9.9 9.9 0 0 1-.775 3.9 9.9 9.9 0 0 1-2.125 3.175q-1.35 1.35-3.175 2.137Q14.1 22 12 22" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconHome.mjs
var import_jsx_runtime45 = __toESM(require_jsx_runtime(), 1);
function n11({ size: t28 = q.base, viewBox: e12 = "0 0 24 24", ...r13 }) {
  return (0, import_jsx_runtime45.jsx)(h4, { size: t28, viewBox: e12, "data-testid": "home", ...r13, children: (0, import_jsx_runtime45.jsx)("path", { d: "M6 19h3v-6h6v6h3v-9l-6-4.5L6 10zm0 2q-.824 0-1.412-.587A1.93 1.93 0 0 1 4 19v-9q0-.476.213-.9.212-.425.587-.7l6-4.5a2.1 2.1 0 0 1 .575-.3q.3-.1.625-.1t.625.1.575.3l6 4.5q.375.275.588.7T20 10v9q0 .825-.587 1.413A1.93 1.93 0 0 1 18 21h-5v-6h-2v6z" }) });
}
...
function f6({
  ...
  return (0, import_jsx_runtime46.jsx)(h4, { size: a32, viewBox: o35, "data-testid": "indeterminate-check-box", ...t28, children: (0, import_jsx_runtime46.jsx)(
    "path",
    {
      fillRule: "evenodd",
...
function l8({ size: o35 = q.base, viewBox: n27 = "0 0 24 24", ...t28 }) {
  return (0, import_jsx_runtime47.jsx)(h4, { size: o35, viewBox: n27, "data-testid": "info", ...t28, children: (0, import_jsx_runtime47.jsxs)(import_jsx_runtime47.Fragment, { children: [
    (0, import_jsx_runtime47.jsx)("path", { d: "M13.25 8a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0M11 16a1 1 0 1 0 2 0v-4a1 1 0 1 0-2 0z" }),
...
function l9({
  size: e12 = q.base,
  viewBox: n27 = "0 0 24 24",
  ...t28
}) {
  return (0, import_jsx_runtime52.jsx)(h4, { size: e12, viewBox: n27, "data-testid": "location-on", ...t28, children: (0, import_jsx_runtime52.jsxs)(import_jsx_runtime52.Fragment, { children: [
    (0, import_jsx_runtime52.jsx)("path", { d: "M10 10c0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2-2 .9-2 2" }),
...
function r9({
  size: e12 = q.base,
  viewBox: i15 = "0 0 24 24",
  ...n27
}) {
  return (0, import_jsx_runtime53.jsx)(h4, { size: e12, viewBox: i15, "data-testid": "location-on-filled", ...n27, children: (0, import_jsx_runtime53.jsx)(
    "path",
    {
      fillRule: "evenodd",
...
function m12({ size: t28 = q.base, viewBox: q4 = "0 0 24 24", ...r13 }) {
  return (0, import_jsx_runtime54.jsx)(h4, { size: t28, viewBox: q4, "data-testid": "lock", ...r13, children: (0, import_jsx_runtime54.jsx)("path", { d: "M6 23q-.824 0-1.412-.587A1.93 1.93 0 0 1 4 21V11q0-.825.588-1.413A1.93 1.93 0 0 1 6 9h1V7q0-2.075 1.463-3.538T12 2t3.538 1.462Q17 4.925 17 7v2h1q.825 0 1.413.587Q20 10.175 20 11v10q0 .825-.587 1.413A1.93 1.93 0 0 1 18 23zm6-5q.825 0 1.413-.587Q14 16.825 14 16t-.587-1.413A1.93 1.93 0 0 0 12 14q-.825 0-1.412.587A1.93 1.93 0 0 0 10 16q0 .825.588 1.413Q11.175 18 12 18M9 9h6V7q0-1.25-.875-2.125A2.9 2.9 0 0 0 12 4q-1.25 0-2.125.875A2.9 2.9 0 0 0 9 7z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconLockOpen.mjs
var import_jsx_runtime55 = __toESM(require_jsx_runtime(), 1);
function A3({ size: t28 = q.base, viewBox: q4 = "0 0 24 24", ...e12 }) {
  return (0, import_jsx_runtime55.jsx)(h4, { size: t28, viewBox: q4, "data-testid": "lock-open", ...e12, children: (0, import_jsx_runtime55.jsx)("path", { d: "M6 22q-.824 0-1.412-.587A1.93 1.93 0 0 1 4 20V10q0-.825.588-1.413A1.93 1.93 0 0 1 6 8h9V6q0-1.25-.875-2.125A2.9 2.9 0 0 0 12 3a2.87 2.87 0 0 0-1.812.612A3 3 0 0 0 9.125 5.15q-.125.375-.387.612A.9.9 0 0 1 8.125 6q-.5 0-.8-.338a.81.81 0 0 1-.2-.762Q7.5 3.225 8.85 2.112T12 1q2.075 0 3.538 1.462Q17 3.925 17 6v2h1q.825 0 1.413.587Q20 9.175 20 10v10q0 .825-.587 1.413A1.93 1.93 0 0 1 18 22zm0-2h12V10H6zm6-3q.825 0 1.413-.587Q14 15.825 14 15t-.587-1.413A1.93 1.93 0 0 0 12 13q-.825 0-1.412.587A1.93 1.93 0 0 0 10 15q0 .825.588 1.413Q11.175 17 12 17" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconLogin.mjs
var import_jsx_runtime56 = __toESM(require_jsx_runtime(), 1);
function l10({ size: o35 = q.base, viewBox: t28 = "0 0 24 24", ...r13 }) {
  return (0, import_jsx_runtime56.jsx)(h4, { size: o35, viewBox: t28, "data-testid": "login", ...r13, children: (0, import_jsx_runtime56.jsx)("path", { d: "M9.325 16.275a1.1 1.1 0 0 1-.275-.738q0-.412.275-.687l1.85-1.85H4a.97.97 0 0 1-.712-.288A.97.97 0 0 1 3 12q0-.425.288-.713A.97.97 0 0 1 4 11h7.175l-1.85-1.85q-.3-.3-.3-.712 0-.413.3-.713.275-.3.688-.3t.687.275l3.6 3.6q.15.15.213.325.062.175.062.375t-.062.375a.9.9 0 0 1-.213.325l-3.6 3.6q-.3.3-.7.275a1 1 0 0 1-.675-.3M13 21a.97.97 0 0 1-.712-.288A.97.97 0 0 1 12 20q0-.424.288-.712A.97.97 0 0 1 13 19h6V5h-6a.97.97 0 0 1-.712-.288A.97.97 0 0 1 12 4q0-.425.288-.713A.97.97 0 0 1 13 3h6q.825 0 1.413.587Q21 4.175 21 5v14q0 .825-.587 1.413A1.93 1.93 0 0 1 19 21z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconLogout.mjs
var import_jsx_runtime57 = __toESM(require_jsx_runtime(), 1);
function l11({ size: t28 = q.base, viewBox: a32 = "0 0 24 24", ...q4 }) {
  return (0, import_jsx_runtime57.jsx)(h4, { size: t28, viewBox: a32, "data-testid": "logout", ...q4, children: (0, import_jsx_runtime57.jsx)("path", { d: "M15.325 16.275a1.1 1.1 0 0 1-.275-.738q0-.412.275-.687l1.85-1.85H10a.97.97 0 0 1-.712-.288A.97.97 0 0 1 9 12q0-.425.288-.713A.97.97 0 0 1 10 11h7.175l-1.85-1.85q-.3-.3-.3-.712 0-.413.3-.713.275-.3.688-.3t.687.275l3.6 3.6q.15.15.213.325.062.175.062.375t-.062.375a.9.9 0 0 1-.213.325l-3.6 3.6q-.325.325-.712.287a1.05 1.05 0 0 1-.663-.312M5 21q-.825 0-1.413-.587A1.93 1.93 0 0 1 3 19V5q0-.825.587-1.413A1.93 1.93 0 0 1 5 3h6a.97.97 0 0 1 .713.287A.97.97 0 0 1 12 4q0 .424-.287.712A.97.97 0 0 1 11 5H5v14h6q.425 0 .713.288A.97.97 0 0 1 12 20q0 .424-.287.712A.97.97 0 0 1 11 21z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconMenu.mjs
var import_jsx_runtime58 = __toESM(require_jsx_runtime(), 1);
function c9({ size: o35 = q.base, viewBox: t28 = "0 0 24 24", ...e12 }) {
  return (0, import_jsx_runtime58.jsx)(h4, { size: o35, viewBox: t28, "data-testid": "menu", ...e12, children: (0, import_jsx_runtime58.jsx)("path", { d: "M4 18a1 1 0 1 1 0-2h16a1 1 0 1 1 0 2zm0-5a1 1 0 1 1 0-2h16a1 1 0 1 1 0 2zM3 7a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconMoreHoriz.mjs
var import_jsx_runtime59 = __toESM(require_jsx_runtime(), 1);
function c10({ size: r13 = q.base, viewBox: t28 = "0 0 24 24", ...a32 }) {
  return (0, import_jsx_runtime59.jsx)(h4, { size: r13, viewBox: t28, "data-testid": "more-horiz", ...a32, children: (0, import_jsx_runtime59.jsx)("path", { d: "M12 14a2 2 0 1 1 .001-4.001A2 2 0 0 1 12 14m4-2a2 2 0 1 0 4.001-.001A2 2 0 0 0 16 12m-8 0a2 2 0 1 0-4.001.001A2 2 0 0 0 8 12" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconMoreVert.mjs
var import_jsx_runtime60 = __toESM(require_jsx_runtime(), 1);
function c11({ size: o35 = q.base, viewBox: t28 = "0 0 24 24", ...e12 }) {
  return (0, import_jsx_runtime60.jsx)(h4, { size: o35, viewBox: t28, "data-testid": "more-vert", ...e12, children: (0, import_jsx_runtime60.jsx)("path", { d: "M14 12a2 2 0 1 1-4.001-.001A2 2 0 0 1 14 12m-2-4a2 2 0 1 0-.001-4.001A2 2 0 0 0 12 8m0 8a2 2 0 1 0 .001 4.001A2 2 0 0 0 12 16" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconOpenInNew.mjs
var import_jsx_runtime61 = __toESM(require_jsx_runtime(), 1);
function c12({ size: e12 = q.base, viewBox: n27 = "0 0 24 24", ...o35 }) {
  return (0, import_jsx_runtime61.jsx)(h4, { size: e12, viewBox: n27, "data-testid": "open-in-new", ...o35, children: (0, import_jsx_runtime61.jsx)("path", { d: "M19 19H5V5h6a1 1 0 1 0 0-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2v-6a1 1 0 1 0-2 0zM15 3a1 1 0 1 0 0 2h2.59l-9.125 9.125a.997.997 0 0 0 1.41 1.41L19 6.41V9a1 1 0 1 0 2 0V3z" }) });
}
...
function f9({
  ...
  return (0, import_jsx_runtime68.jsx)(h4, { size: o35, viewBox: a32, "data-testid": "radio-button-checked", ...e12, children: (0, import_jsx_runtime68.jsx)("path", { d: "M12 17q2.075 0 3.538-1.463Q17 14.075 17 12t-1.462-3.538Q14.075 7 12 7T8.463 8.462Q7 9.925 7 12t1.463 3.537T12 17m0 5a9.7 9.7 0 0 1-3.9-.788 10.1 10.1 0 0 1-3.175-2.137q-1.35-1.35-2.137-3.175A9.7 9.7 0 0 1 2 12q0-2.075.788-3.9a10.1 10.1 0 0 1 2.137-3.175q1.35-1.35 3.175-2.138A9.7 9.7 0 0 1 12 2q2.075 0 3.9.787a10.1 10.1 0 0 1 3.175 2.138q1.35 1.35 2.137 3.175A9.7 9.7 0 0 1 22 12a9.7 9.7 0 0 1-.788 3.9 10.1 10.1 0 0 1-2.137 3.175q-1.35 1.35-3.175 2.137A9.7 9.7 0 0 1 12 22m0-2q3.35 0 5.675-2.325T20 12t-2.325-5.675T12 4 6.325 6.325 4 12t2.325 5.675T12 20" }) });
}
...
function f10({
  ...
  return (0, import_jsx_runtime69.jsx)(h4, { size: t28, viewBox: e12, "data-testid": "radio-button-unchecked", ...n27, children: (0, import_jsx_runtime69.jsx)("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconReact.mjs
var import_jsx_runtime70 = __toESM(require_jsx_runtime(), 1);
function i8({ size: a32 = q.base, viewBox: e12 = "0 0 24 24", ...q4 }) {
  return (0, import_jsx_runtime70.jsx)(h4, { size: a32, viewBox: e12, "data-testid": "react", ...q4, children: (0, import_jsx_runtime70.jsxs)(import_jsx_runtime70.Fragment, { children: [
    (0, import_jsx_runtime70.jsx)("path", { d: "M13.96 11.952c0 1.099-.877 1.99-1.96 1.99s-1.96-.891-1.96-1.99.877-1.989 1.96-1.989 1.96.89 1.96 1.99" }),
...
function c15({ size: e12 = q.base, viewBox: r13 = "0 0 24 24", ...t28 }) {
  return (0, import_jsx_runtime71.jsx)(h4, { size: e12, viewBox: r13, "data-testid": "remove", ...t28, children: (0, import_jsx_runtime71.jsx)("path", { d: "M6 13a.97.97 0 0 1-.713-.288A.97.97 0 0 1 5 12a.97.97 0 0 1 .287-.713A.97.97 0 0 1 6 11h12q.424 0 .712.287.288.288.288.713 0 .424-.288.712A.97.97 0 0 1 18 13z" }) });
}
...
function e7({
  ...
  return (0, import_jsx_runtime78.jsx)(h4, { size: o35, viewBox: q4, "data-testid": "shopping-cart", ...r13, children: (0, import_jsx_runtime78.jsx)("path", { d: "M7 22q-.824 0-1.412-.587A1.93 1.93 0 0 1 5 20q0-.824.588-1.413A1.93 1.93 0 0 1 7 18q.824 0 1.412.587Q9 19.176 9 20t-.588 1.413A1.93 1.93 0 0 1 7 22m10 0q-.825 0-1.412-.587A1.93 1.93 0 0 1 15 20q0-.824.588-1.413A1.93 1.93 0 0 1 17 18q.824 0 1.413.587Q19 19.176 19 20t-.587 1.413A1.93 1.93 0 0 1 17 22M6.15 6l2.4 5h7l2.75-5zM7 17q-1.125 0-1.7-.988-.575-.987-.05-1.962L6.6 11.6 3 4H1.975a.93.93 0 0 1-.7-.288A1 1 0 0 1 1 3q0-.424.288-.712A.97.97 0 0 1 2 2h1.625q.274 0 .525.15.25.15.375.425L5.2 4h14.75q.675 0 .925.5t-.025 1.05l-3.55 6.4a2.03 2.03 0 0 1-.725.775q-.45.275-1.025.275H8.1L7 15h11.025q.425 0 .7.287.275.288.275.713 0 .424-.288.712A.97.97 0 0 1 18 17z" }) });
}
...
function m14({
  ...
  return (0, import_jsx_runtime82.jsx)(h4, { size: a32, viewBox: r13, "data-testid": "star-filled", ...o35, children: (0, import_jsx_runtime82.jsx)("path", { d: "m12 18.275-4.15 2.5a.9.9 0 0 1-.575.15.97.97 0 0 1-.525-.2 1.2 1.2 0 0 1-.35-.437.88.88 0 0 1-.05-.588l1.1-4.725L3.775 11.8a.96.96 0 0 1-.312-.513 1 1 0 0 1 .037-.562 1.1 1.1 0 0 1 .3-.45q.2-.176.55-.225l4.85-.425 1.875-4.45q.125-.3.388-.45t.537-.15.538.15q.262.15.387.45l1.875 4.45 4.85.425q.35.05.55.225t.3.45.038.562a.96.96 0 0 1-.313.513l-3.675 3.175 1.1 4.725a.88.88 0 0 1-.05.588 1.2 1.2 0 0 1-.35.437.97.97 0 0 1-.525.2.9.9 0 0 1-.575-.15z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconStarHalf.mjs
var import_jsx_runtime83 = __toESM(require_jsx_runtime(), 1);
function n17({ size: t28 = q.base, viewBox: r13 = "0 0 24 24", ...o35 }) {
  return (0, import_jsx_runtime83.jsx)(h4, { size: t28, viewBox: r13, "data-testid": "star-half", ...o35, children: (0, import_jsx_runtime83.jsx)("path", { d: "M12 8.125v7.8l3.15 1.925-.825-3.6 2.775-2.4-3.65-.325zm0 10.15-4.15 2.5a.9.9 0 0 1-.575.15.97.97 0 0 1-.525-.2 1.2 1.2 0 0 1-.35-.437.88.88 0 0 1-.05-.588l1.1-4.725L3.775 11.8a.96.96 0 0 1-.312-.513 1 1 0 0 1 .037-.562 1.1 1.1 0 0 1 .3-.45q.2-.176.55-.225l4.85-.425 1.875-4.45q.125-.3.388-.45t.537-.15.538.15q.262.15.387.45l1.875 4.45 4.85.425q.35.05.55.225t.3.45.038.562a.96.96 0 0 1-.313.513l-3.675 3.175 1.1 4.725a.88.88 0 0 1-.05.588 1.2 1.2 0 0 1-.35.437.97.97 0 0 1-.525.2.9.9 0 0 1-.575-.15z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconThumbDown.mjs
var import_jsx_runtime84 = __toESM(require_jsx_runtime(), 1);
function i11({ size: t28 = q.base, viewBox: r13 = "0 0 24 24", ...h9 }) {
  return (0, import_jsx_runtime84.jsx)(h4, { size: t28, viewBox: r13, "data-testid": "thumb-down", ...h9, children: (0, import_jsx_runtime84.jsx)("path", { d: "M3 16q-.8 0-1.4-.6T1 14v-2q0-.175.05-.375t.1-.375l3-7.05q.225-.5.75-.85T6 3h11v13l-6 5.95q-.375.375-.887.437a1.65 1.65 0 0 1-.988-.187 1.58 1.58 0 0 1-.7-.7q-.225-.45-.1-.925L9.45 16zm12-.85V5H6l-3 7v2h9l-1.35 5.5zM20 3q.825 0 1.413.587Q22 4.175 22 5v9q0 .825-.587 1.412A1.93 1.93 0 0 1 20 16h-3v-2h3V5h-3V3z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconThumbUp.mjs
var import_jsx_runtime85 = __toESM(require_jsx_runtime(), 1);
function n18({ size: o35 = q.base, viewBox: r13 = "0 0 24 24", ...e12 }) {
  return (0, import_jsx_runtime85.jsx)(h4, { size: o35, viewBox: r13, "data-testid": "thumb-up", ...e12, children: (0, import_jsx_runtime85.jsx)("path", { d: "M7 22V9l6-5.95q.375-.375.887-.438.513-.061.988.188.475.25.7.7t.1.925L14.55 9H21q.8 0 1.4.6T23 11v2q0 .176-.05.375-.05.2-.1.375l-3 7.05q-.225.5-.75.85T18 22zM9 9.85V20h9l3-7v-2h-9l1.35-5.5zM4 22q-.824 0-1.412-.587A1.93 1.93 0 0 1 2 20v-9q0-.824.588-1.413A1.93 1.93 0 0 1 4 9h3v2H4v9h3v2z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconTune.mjs
var import_jsx_runtime86 = __toESM(require_jsx_runtime(), 1);
function n19({ size: a32 = q.base, viewBox: q4 = "0 0 24 24", ...t28 }) {
  return (0, import_jsx_runtime86.jsx)(h4, { size: a32, viewBox: q4, "data-testid": "tune", ...t28, children: (0, import_jsx_runtime86.jsx)("path", { d: "M4 19a.97.97 0 0 1-.712-.288A.97.97 0 0 1 3 18q0-.424.288-.712A.97.97 0 0 1 4 17h4q.425 0 .713.288A.97.97 0 0 1 9 18q0 .424-.287.712A.97.97 0 0 1 8 19zM4 7a.97.97 0 0 1-.712-.287A.97.97 0 0 1 3 6q0-.425.288-.713A.97.97 0 0 1 4 5h8a.97.97 0 0 1 .713.287A.97.97 0 0 1 13 6a.97.97 0 0 1-.287.713A.97.97 0 0 1 12 7zm8 14a.97.97 0 0 1-.712-.288A.97.97 0 0 1 11 20v-4q0-.425.288-.713A.97.97 0 0 1 12 15a.97.97 0 0 1 .713.287A.97.97 0 0 1 13 16v1h7q.424 0 .712.288A.97.97 0 0 1 21 18q0 .424-.288.712A.97.97 0 0 1 20 19h-7v1q0 .424-.287.712A.97.97 0 0 1 12 21m-4-6a.97.97 0 0 1-.713-.288A.97.97 0 0 1 7 14v-1H4a.97.97 0 0 1-.712-.288A.97.97 0 0 1 3 12q0-.425.288-.713A.97.97 0 0 1 4 11h3v-1a.97.97 0 0 1 .287-.713A.97.97 0 0 1 8 9a.97.97 0 0 1 .713.287A.97.97 0 0 1 9 10v4q0 .424-.287.712A.97.97 0 0 1 8 15m4-2a.97.97 0 0 1-.712-.288A.97.97 0 0 1 11 12q0-.425.288-.713A.97.97 0 0 1 12 11h8q.424 0 .712.287.288.288.288.713 0 .424-.288.712A.97.97 0 0 1 20 13zm4-4a.97.97 0 0 1-.712-.288A.97.97 0 0 1 15 8V4q0-.425.288-.713A.97.97 0 0 1 16 3q.424 0 .712.287Q17 3.575 17 4v1h3q.424 0 .712.287Q21 5.575 21 6a.97.97 0 0 1-.288.713A.97.97 0 0 1 20 7h-3v1q0 .424-.288.712A.97.97 0 0 1 16 9" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconTwitter.mjs
var import_jsx_runtime87 = __toESM(require_jsx_runtime(), 1);
function m15({ size: a32 = q.base, viewBox: r13 = "0 0 24 24", ...o35 }) {
  return (0, import_jsx_runtime87.jsx)(h4, { size: a32, viewBox: r13, "data-testid": "twitter", ...o35, children: (0, import_jsx_runtime87.jsx)("path", { d: "M19.944 8.048c.013.178.013.356.013.533 0 5.419-4.124 11.663-11.663 11.663-2.322 0-4.48-.673-6.294-1.84.33.038.647.05.99.05 1.916 0 3.68-.647 5.089-1.75a4.11 4.11 0 0 1-3.833-2.844c.254.039.508.064.774.064.368 0 .736-.05 1.079-.14a4.1 4.1 0 0 1-3.287-4.023v-.05c.546.304 1.18.495 1.853.52a4.1 4.1 0 0 1-1.827-3.414c0-.761.203-1.46.558-2.068a11.65 11.65 0 0 0 8.452 4.29 4.6 4.6 0 0 1-.102-.94A4.097 4.097 0 0 1 15.846 4a4.1 4.1 0 0 1 2.994 1.294 8.1 8.1 0 0 0 2.602-.99 4.1 4.1 0 0 1-1.802 2.26A8.2 8.2 0 0 0 22 5.928a8.8 8.8 0 0 1-2.056 2.12" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconUndo.mjs
var import_jsx_runtime88 = __toESM(require_jsx_runtime(), 1);
function m16({ size: t28 = q.base, viewBox: a32 = "0 0 24 24", ...r13 }) {
  return (0, import_jsx_runtime88.jsx)(h4, { size: t28, viewBox: a32, "data-testid": "undo", ...r13, children: (0, import_jsx_runtime88.jsx)("path", { d: "M8 19.5a.97.97 0 0 1-.712-.288A.97.97 0 0 1 7 18.5q0-.425.288-.713A.97.97 0 0 1 8 17.5h6.1q1.576 0 2.737-1Q18 15.5 18 14t-1.163-2.5-2.737-1H7.8l1.9 1.9a.95.95 0 0 1 .275.7.95.95 0 0 1-.275.7.95.95 0 0 1-.7.275.95.95 0 0 1-.7-.275l-3.6-3.6a.9.9 0 0 1-.212-.325 1.1 1.1 0 0 1-.063-.375q0-.201.063-.375A.9.9 0 0 1 4.7 8.8l3.6-3.6a.95.95 0 0 1 .7-.275q.425 0 .7.275a.95.95 0 0 1 .275.7.95.95 0 0 1-.275.7L7.8 8.5h6.3q2.425 0 4.163 1.575Q20 11.65 20 14t-1.738 3.925Q16.526 19.5 14.1 19.5z" }) });
}
...
function n21({
  ...
  return (0, import_jsx_runtime92.jsx)(h4, { size: i15, viewBox: o35, "data-testid": "visibility", ...r13, children: (0, import_jsx_runtime92.jsx)("path", { d: "M12 16q1.875 0 3.188-1.312Q16.5 13.375 16.5 11.5t-1.312-3.188Q13.875 7 12 7T8.812 8.312Q7.5 9.625 7.5 11.5t1.312 3.188Q10.125 16 12 16m0-1.8q-1.125 0-1.912-.788A2.6 2.6 0 0 1 9.3 11.5q0-1.125.788-1.913A2.6 2.6 0 0 1 12 8.8q1.125 0 1.913.787.787.788.787 1.913t-.787 1.912A2.6 2.6 0 0 1 12 14.2m0 4.8q-3.475 0-6.35-1.837Q2.775 15.325 1.3 12.2a.8.8 0 0 1-.1-.313 3 3 0 0 1 0-.775.8.8 0 0 1 .1-.312q1.475-3.125 4.35-4.962Q8.525 4 12 4t6.35 1.838T22.7 10.8q.075.124.1.312a3 3 0 0 1 0 .775.8.8 0 0 1-.1.313q-1.474 3.125-4.35 4.963Q15.475 19 12 19" }) });
}
...
function e8({
  ...
  return (0, import_jsx_runtime94.jsx)(h4, { size: o35, viewBox: t28, "data-testid": "vsf-diamond", ...f15, children: (0, import_jsx_runtime94.jsx)("path", { d: "M7.888 2.174c-.761.473-1.508 1.22-3 2.713-1.494 1.493-2.24 2.24-2.714 3a7.79 7.79 0 0 0 0 8.226c.473.76 1.22 1.506 2.712 2.999 1.494 1.494 2.24 2.24 3.002 2.714a7.79 7.79 0 0 0 8.224 0c.761-.474 1.508-1.22 3-2.713 1.494-1.493 2.24-2.24 2.714-3a7.79 7.79 0 0 0 0-8.225c-.474-.761-1.22-1.508-2.713-3-1.493-1.494-2.24-2.24-3-2.714a7.79 7.79 0 0 0-8.225 0" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconVuejs.mjs
var import_jsx_runtime95 = __toESM(require_jsx_runtime(), 1);
function m18({ size: t28 = q.base, viewBox: e12 = "0 0 24 24", ...r13 }) {
  return (0, import_jsx_runtime95.jsx)(h4, { size: t28, viewBox: e12, "data-testid": "vuejs", ...r13, children: (0, import_jsx_runtime95.jsx)("path", { d: "M18.526 2.3H14.75L12 6.65 9.643 2.3H1l11 18.843L23 2.3zM3.736 3.871h2.641L12 13.605l5.618-9.734h2.642L12 18.024z" }) });
}
...
function l14({
  ...
  return (0, import_jsx_runtime96.jsx)(h4, { size: t28, viewBox: a32, "data-testid": "vuestorefront", ...r13, children: (0, import_jsx_runtime96.jsx)("path", { d: "m9.747 2.824.839-.838a2 2 0 0 1 2.828 0l.838.838a2 2 0 0 1 0 2.828l-.838.839a2 2 0 0 1-2.828 0l-.839-.839a2 2 0 0 1 0-2.828m3.69 10.978 4.482-4.483a2 2 0 0 1 2.829 0L23 11.571l-11 11-11-11 2.276-2.276a2 2 0 0 1 2.827 0l4.506 4.507a2 2 0 0 0 2.828 0" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconWarehouse.mjs
var import_jsx_runtime97 = __toESM(require_jsx_runtime(), 1);
function i12({ size: e12 = q.base, viewBox: r13 = "0 0 24 24", ...t28 }) {
  return (0, import_jsx_runtime97.jsx)(h4, { size: e12, viewBox: r13, "data-testid": "warehouse", ...t28, children: (0, import_jsx_runtime97.jsx)("path", { d: "m12 5.15-8 3.2V19h2v-6q0-.824.588-1.413A1.93 1.93 0 0 1 8 11h8q.825 0 1.413.587Q18 12.175 18 13v6h2V8.35zM8 21H4q-.824 0-1.412-.587A1.93 1.93 0 0 1 2 19V8.35A1.96 1.96 0 0 1 3.25 6.5l8-3.2q.35-.15.75-.15t.75.15l8 3.2q.575.225.913.725.337.5.337 1.125V19q0 .825-.587 1.413A1.93 1.93 0 0 1 20 21h-4v-8H8zm1 0v-2h2v2zm2-3v-2h2v2zm2 3v-2h2v2z" }) });
}

// node_modules/@storefront-ui/react/dist/components/SfIcons/SfIconWarning.mjs
var import_jsx_runtime98 = __toESM(require_jsx_runtime(), 1);
function f11({ size: a32 = q.base, viewBox: n27 = "0 0 24 24", ...o35 }) {
  return (0, import_jsx_runtime98.jsx)(h4, { size: a32, viewBox: n27, "data-testid": "warning", ...o35, children: (0, import_jsx_runtime98.jsx)(
    "path",
    {
      fillRule: "evenodd",
...
function n23({ size: t28 = q.base, viewBox: a32 = "0 0 24 24", ...e12 }) {
  return (0, import_jsx_runtime99.jsx)(h4, { size: t28, viewBox: a32, "data-testid": "youtube", ...e12, children: (0, import_jsx_runtime99.jsx)("path", { d: "M22.54 6.42a2.76 2.76 0 0 0-1.944-1.957C18.88 4 12 4 12 4s-6.88 0-8.596.463A2.76 2.76 0 0 0 1.46 6.42C1 8.147 1 11.75 1 11.75s0 3.603.46 5.33a2.72 2.72 0 0 0 1.945 1.926c1.716.463 8.596.463 8.596.463s6.879 0 8.595-.463a2.72 2.72 0 0 0 1.945-1.926c.46-1.727.46-5.33.46-5.33s0-3.603-.46-5.33M9.75 15.021V8.48l5.75 3.271z" }) });
}
...
var s4 = Ht();
var f12 = (t28 = {}) => {
  s4.setupGlobalFocusEvents();
  const { isTextInput: e12, autoFocus: i15 } = t28, [n27, u9] = (0, import_react7.useState)(i15 || s4.isFocusVisible());
  return (0, import_react7.useEffect)(() => {
    const o35 = (c21, r13) => {
      s4.isKeyboardFocusEvent(e12, c21, r13) && u9(s4.isFocusVisible());
    };
    return s4.changeHandlers.add(o35), () => {
      s4.changeHandlers.delete(o35);
    };
  }, [e12]), { isFocusVisible: n27 };
};
...
var I = f(
  ({ wrapperAs: i15, size: n27 = $.base, slotPrefix: a32, slotSuffix: s10, invalid: e12, className: o35, wrapperClassName: p10, ...u9 }, c21) => {
    const l20 = i15 || h6, { isFocusVisible: m25 } = f12({ isTextInput: true });
      ...
      l20,
      {
        className: (0, import_classnames10.default)([
          "flex items-center gap-2 px-4 bg-white rounded-md ring-1 text-neutral-500 hover:ring-primary-700 focus-within:caret-primary-700 active:caret-primary-700 active:ring-primary-700 active:ring-2 focus-within:ring-primary-700 focus-within:ring-2",
          {
            ...
            "ring-1 ring-neutral-300": !e12,
            "focus-within:outline focus-within:outline-offset": m25
          },
          b3[n27],
          p10
        ]),
...
var b4 = f((t28, a32) => {
  ...
  }, { as: e12, className: s10, children: o35, variant: n27 = R.primary, ...m25 } = t28;
...
var C3 = f((o35, r13) => {
  ...
  return (0, import_jsx_runtime102.jsxs)(
    x6,
    {
      ...
      ...p10,
      children: [
        i15 && (0, import_jsx_runtime102.jsx)(t28, { className: e12 ? "text-disabled-500" : "text-neutral-500", children: i15 }),
        (0, import_jsx_runtime102.jsx)(t28, { className: "flex flex-col w-full min-w-0", children: u9 }),
        a32 && (0, import_jsx_runtime102.jsx)(t28, { className: e12 ? "text-disabled-500" : "text-neutral-500", children: a32 })
      ]
    }
  );
});
...
var e10 = ((r13) => (r13.minimal = "minimal", r13))(e10 || {});
...
var isDetailsWithSummary = function isDetailsWithSummary2(node) {
  var r13 = node.tagName === "DETAILS" && Array.prototype.slice.apply(node.children).some(function(child) {
...
var z3 = (e12, C5) => {
  const {
    trapTabs: p10,
    arrowFocusGroupSelector: f15,
    includeContainer: b8,
    activeState: k3,
    initialFocus: s10,
    arrowKeysOn: F3,
    arrowKeysLeftRight: m25,
    arrowKeysUpDown: A6,
    initialFocusContainerFallback: E2
  } = {
    ...P3,
    ...C5
  }, [i15, L2] = (0, import_react8.useState)(), [u9, l20] = (0, import_react8.useState)([]), n27 = ({
    event: r13,
    additionalData: t28
  }) => Mt({
    current: i15,
    ...
    event: r13,
    ...t28
  }), w4 = (0, import_react8.useCallback)(
    (r13) => {
      var c21;
      const o35 = f15 && ((c21 = e12.current) == null ? void 0 : c21.querySelector(f15)) ? { arrowFocusGroupSelector: f15 } : {};
      F3 && (r13.key === "ArrowLeft" || r13.key === "ArrowUp") && n27({ additionalData: o35 }), F3 && (r13.key === "ArrowRight" || r13.key === "ArrowDown") && a32({ additionalData: o35 }), m25 && r13.key === "ArrowLeft" && n27({ additionalData: o35 }), m25 && r13.key === "ArrowRight" && a32({ additionalData: o35 }), A6 && r13.key === "ArrowUp" && n27({ additionalData: o35 }), A6 && r13.key === "ArrowDown" && a32({ additionalData: o35 }), p10 && bt(r13) && a32({ event: r13 }), p10 && yt(r13) && n27({ event: r13 });
    },
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [i15]
  ), h9 = () => {
    const r13 = document.activeElement;
    L2(r13);
  }, T2 = () => {
    var r13, t28;
    (r13 = e12.current) == null || r13.removeEventListener("keydown", w4), (t28 = e12.current) == null || t28.removeEventListener("focus", h9, true);
  };
  return (0, import_react8.useEffect)(() => {
    var r13, t28, o35, c21;
    if (e12.current && k3) {
      (r13 = e12.current) == null || r13.addEventListener("focus", h9, true), (t28 = e12.current) == null || t28.addEventListener("keydown", w4);
      let y6 = false;
      if (l20(tabbable(e12.current, { includeContainer: b8 })), typeof s10 == "number")
        u9[s10] ? (o35 = u9[s10]) == null || o35.focus() : (console.error(`There is no element with given index ${s10}`), y6 = true);
      else if (s10 === "autofocus") {
        const K2 = u9.find((d12) => d12 == null ? void 0 : d12.hasAttribute("autofocus"));
        K2 ? K2.focus() : y6 = true;
      }
      (E2 && y6 || s10 === "container") && ((c21 = e12.current) == null || c21.focus());
    } else
      l20([]), L2(void 0);
    return T2;
  }, [e12.current, k3, w4]), {
    ...
    updateFocusableElements: () => {
      e12.current && l20(tabbable(e12.current, { includeContainer: b8 }));
    }
  };
};
...
var D = "div";
var j3 = f(
  ({ as: m25, open: e12, disableClickAway: n27, disableEsc: t28, onClose: r13, className: d12, children: c21, ...o35 }, l20) => {
    const p10 = m25 || D, a32 = (0, import_react9.useRef)(null);
    useClickAway_default(a32, () => {
      n27 || r13 == null || r13();
    });
    const u9 = (f15) => {
      var i15;
      if (!t28 && f15.key === "Escape" && (r13 == null || r13()), "onKeyDown" in o35 && typeof o35.onKeyDown == "function")
        return (i15 = o35.onKeyDown) == null ? void 0 : i15.call(o35, f15);
    };
    return z3(a32, {
      trapTabs: true,
      activeState: e12,
    ...
    }), e12 ? (0, import_jsx_runtime105.jsx)(
      p10,
      {
        ref: o3([a32, l20]),
    ...
    "svg",
    {
      ...
      children: [
        (0, import_jsx_runtime106.jsx)(
          "circle",
          {
            className: (0, import_classnames16.default)("origin-bottom-right -rotate-90 stroke-current fill-none", c17[e12]),
            cx: "50",
            cy: "50",
            r: "24"
          }
...
var e11 = ((r13) => (r13.minimal = "minimal", r13))(e11 || {});
...
function $2({
  ...
  const l20 = Lt(Dt(i15, c21 ? 0.5 : 1), 0, t28), a32 = +!Number.isInteger(l20), o35 = Math.ceil(l20 - a32), x6 = t28 - o35 - a32, m25 = d12 ?? `${i15} out of ${t28}`;
  return (0, import_jsx_runtime108.jsxs)(
    "div",
    {
      ...
      "aria-label": m25,
      title: m25,
      className: (0, import_classnames18.default)("inline-flex items-center text-warning-500", w3[n27], f15),
      "data-testid": "rating",
      ...p10,
      children: [
        [...Array(o35).keys()].map((r13) => (0, import_jsx_runtime108.jsx)(m14, { "aria-hidden": "true", className: "w-[1.5em] h-[1.5em]" }, r13)),
        !!a32 && (0, import_jsx_runtime108.jsx)(n17, { "aria-hidden": "true", className: "w-[1.5em] h-[1.5em]" }),
        [...Array(x6).keys()].map((r13) => (0, import_jsx_runtime108.jsx)(l12, { "aria-hidden": "true", className: "text-disabled-500 w-[1.5em] h-[1.5em]" }, r13))
      ]
    }
  );
}
...
var n25 = (...r13) => (...t28) => {
  r13.forEach((e12) => e12 == null ? void 0 : e12(...t28));
};
function o31(r13) {
  return function(e12 = {}) {
    return {
...
function I2(p10) {
  const {
    ...
    onKeyDown: w4,
    ...S2
  } = p10, { isFocusVisible: C5 } = f12(), [N4, s10] = (0, import_react10.useState)(false), i15 = () => s10(true), l20 = () => s10(false), k3 = (D2) => {
    D2.code === "Space" && i15();
  };
          ...
          "select",
          {
            ...
            className: (0, import_classnames19.default)(
              "appearance-none disabled:cursor-not-allowed cursor-pointer pl-4 pr-3.5 text-neutral-900 focus:ring-primary-700 focus:ring-2 outline-none bg-transparent rounded-md ring-1 ring-inset ring-neutral-300 hover:ring-primary-700 active:ring-2 active:ring-primary-700 disabled:bg-disabled-100 disabled:text-disabled-900 disabled:ring-disabled-200",
              {
                "py-1.5": t28 === B.sm,
                "py-2": t28 === B.base,
                "py-3 text-base": t28 === B.lg,
                "!ring-negative-700 ring-2": m25 && !n27
              },
              h9
            ),
            ...
            ...S2,
            children: [
              a32 && (0, import_jsx_runtime109.jsx)(
                "option",
                {
                  hidden: true,
                  value: "",
                  className: (0, import_classnames19.default)("bg-neutral-300 text-sm", {
                    "text-base": t28 === B.lg
                  }),
...
var t24 = (0, import_react11.forwardRef)(
  ({ invalid: r13, className: o35, ...e12 }, b8) => (0, import_jsx_runtime110.jsx)(
    "input",
    {
      ref: b8,
      className: (0, import_classnames20.default)(
        ...
        {
          "border-negative-700 hover:border-negative-800 active:border-negative-900 before:bg-negative-900": r13
        },
        o35
      ),
      type: "checkbox",
...
function z4({
  ...
  onPrev: u9,
  onNext: d12,
  isActiveIndexCentered: m25
} = {}) {
  const f15 = (0, import_react12.useRef)(null), l20 = (0, import_react12.useRef)(null), [i15, k3] = (0, import_react12.useState)({ hasPrev: false, hasNext: false, isDragged: false });
  (0, import_react12.useEffect)(() => {
    const e12 = f15.current;
    if (!e12)
      return () => {
      };
    l20.current = new Et(e12, {
      direction: b8,
      drag: h9,
      reduceMotion: o35,
      onPrev: u9,
      onNext: d12,
      onScroll: (t28) => {
        k3((a32) => ({ ...a32, hasNext: t28.hasNext, hasPrev: t28.hasPrev })), c21 == null || c21(t28);
      },
      onDragStart: (t28) => {
        k3((a32) => ({ ...a32, isDragged: t28.isDragged })), s10 == null || s10(t28);
      },
      onDragEnd: r13
    });
    const R2 = l20.current.register();
    return typeof n27 == "number" && n27 >= 0 && m25 && l20.current.scrollToIndex(n27), R2;
  }, [
    f15,
    n27,
    b8,
  ...
  const N4 = (0, import_react12.useCallback)(() => {
    var e12;
    (e12 = l20.current) == null || e12.prev();
  }, []), g7 = (0, import_react12.useCallback)(() => {
    var e12;
    (e12 = l20.current) == null || e12.next();
  }, []), v6 = o31((e12) => ({
    onClick: n25(N4, e12 == null ? void 0 : e12.onClick),
    disabled: typeof e12.disabled < "u" ? e12.disabled : !i15.hasPrev
  })), B3 = o31((e12) => ({
    onClick: n25(g7, e12 == null ? void 0 : e12.onClick),
    disabled: typeof e12.disabled < "u" ? e12.disabled : !i15.hasNext
  }));
  return {
    containerRef: f15,
    getPrevButtonProps: v6,
...
var se = f(
  ({
    ...
    style: Z2,
    children: P5,
    slotPreviousButton: S2,
    slotNextButton: k3,
    ...T2
  }, H2) => {
    const L2 = R2 || Y2, e12 = i15 === u.horizontal, s10 = a32 === T.block, l20 = a32 === T.floating, O2 = (0, import_react13.useMemo)(
      () => ({
        direction: i15,
        activeIndex: m25,
        reduceMotion: c21,
    ...
    ), { state: E2, containerRef: G4, getNextButtonProps: B3, getPrevButtonProps: N4 } = z4(O2);
    function I3({ classNameButton: d12 }) {
      return S2 ? (0, import_react13.cloneElement)(S2, N4({ disabled: x6, onClick: n27 })) : (0, import_jsx_runtime111.jsx)(
        z2,
        {
          ...N4({
            square: true,
            ...
            size: "lg",
            disabled: x6,
            slotPrefix: (0, import_jsx_runtime111.jsx)(l6, {}),
            "aria-label": q4,
            className: (0, import_classnames21.default)(
              d12,
              l20 ? "disabled:hidden" : "disabled:!ring-disabled-300 disabled:!text-disabled-500"
            )
          })
        }
      );
    }
    function J2({ classNameButton: d12 }) {
      return k3 ? (0, import_react13.cloneElement)(k3, B3({ disabled: z5, onClick: f15 })) : (0, import_jsx_runtime111.jsx)(
        z2,
        {
          ...B3({
            square: true,
            ...
            size: "lg",
            disabled: z5,
            slotPrefix: (0, import_jsx_runtime111.jsx)(h5, {}),
            "aria-label": F3,
            className: (0, import_classnames21.default)(
              d12,
              l20 ? "disabled:hidden" : "disabled:!ring-disabled-300 disabled:!text-disabled-500"
    ...
    return (0, import_jsx_runtime111.jsxs)(
      "div",
      {
        ...
        children: [
          a32 !== T.none && (0, import_jsx_runtime111.jsx)(
            I3,
            {
              classNameButton: (0, import_classnames21.default)("!rounded-full bg-white hidden md:block !ring-neutral-500 !text-neutral-500", {
                "mr-4": s10 && e12,
                "mb-4 rotate-90": s10 && !e12,
                "absolute left-4 z-10": l20 && e12,
                "absolute top-4 rotate-90 z-10": l20 && !e12
              })
            }
          ),
          (0, import_jsx_runtime111.jsx)(
            L2,
            {
              className: (0, import_classnames21.default)(C5, "motion-safe:scroll-smooth", {
                "overflow-x-auto flex gap-4": e12,
                "overflow-y-auto flex flex-col gap-4": !e12,
                "cursor-grab": E2.isDragged
              }),
              ref: o3([G4, H2]),
              ...T2,
              children: P5
          ...
          a32 !== T.none && (0, import_jsx_runtime111.jsx)(
            J2,
            {
              classNameButton: (0, import_classnames21.default)("!rounded-full bg-white hidden md:block !ring-neutral-500 !text-neutral-500", {
                ...
                "absolute right-4 z-10": l20 && e12,
                "absolute bottom-4 rotate-90 z-10": l20 && !e12
              })
            }
          )
        ]
...
function p7({ initialValue: t28 = false } = {}) {
  const [o35, e12] = (0, import_react14.useState)(t28), n27 = (0, import_react14.useCallback)(() => e12(true), []), c21 = (0, import_react14.useCallback)(() => e12(false), []), l20 = (0, import_react14.useCallback)(() => e12((r13) => !r13), []);
  return { isOpen: o35, open: n27, close: c21, toggle: l20 };
}
...
function F2(w4) {
  const {
    placement: n27 = "top",
    middleware: g7 = [offset3(8), shift3(), flip3()],
    arrowSize: o35 = "6px",
    ...y6
  } = w4 || {}, t28 = (0, import_react15.useRef)(null), { isOpen: l20, open: p10, close: i15, toggle: d12 } = p7(), {
    refs: r13,
    style: a32,
    middlewareData: f15
  } = P2({
    isOpen: l20,
    placement: n27,
    middleware: [...g7, arrow3({ element: t28 })],
    ...y6
  });
  function m25() {
    if (f15.arrow) {
      const { x: e12, y: c21 } = f15.arrow, P5 = n27.split("-")[0];
      return {
        position: "absolute",
        width: o35,
        height: o35,
        top: typeof c21 == "number" ? `${c21}px` : "",
  ...
  const b8 = o31((e12) => ({
    ref: r13.setReference,
    onMouseEnter: n25(p10, e12.onMouseEnter),
    onMouseLeave: n25(i15, e12.onMouseLeave)
  })), h9 = o31((e12) => ({
    ref: r13.setFloating,
    style: { ...e12.style, ...a32 }
  })), x6 = o31((e12) => ({
...
// node_modules/@storefront-ui/react/dist/components/SfTooltip/SfTooltip.mjs
function h8(s10) {
  const { children: e12, label: o35, className: r13, style: p10, showArrow: a32, ...l20 } = s10, { isOpen: i15, getTriggerProps: n27, getTooltipProps: d12, getArrowProps: c21 } = F2(l20);
  return (0, import_jsx_runtime112.jsxs)("span", { ...n27({ className: r13, style: p10 }), "data-testid": "tooltip", children: [
    e12,
    o35 && i15 && (0, import_jsx_runtime112.jsxs)(
      "div",
      {
        ...d12({
          role: "tooltip",
        ...
        children: [
          o35,
          a32 && (0, import_jsx_runtime112.jsx)("span", { ...c21({ className: "bg-black rotate-45" }) })
        ]
      }
    )
  ] });
...
function d9({
  ...
  return (0, import_jsx_runtime113.jsx)(
    "div",
    {
      className: (0, import_classnames22.default)("rounded-full overflow-hidden bg-clip-content p-0.5", m23[e12], t28),
...
function j5(t28) {
  return `${t28} Star${t28 !== 1 ? "s" : ""}`;
}
var B2 = ({ isFilled: t28, iconSize: r13 }) => t28 ? (0, import_jsx_runtime114.jsx)(
  m14,
  {
    role: "none",
...
function E({
  ...
  const [a32, c21] = (0, import_react16.useState)(0), S2 = Array.from({ length: Math.floor(Math.abs(l20)) }, (e12, I3) => I3 + 1), x6 = (e12) => e12 <= a32 || a32 === 0 && e12 <= r13, h9 = (e12) => {
    t28 == null || t28(Number(e12.target.value));
  }, v6 = (e12) => () => {
    i15 || c21(e12);
  }, z5 = () => {
    i15 || c21(0);
  };
  return (0, import_jsx_runtime114.jsx)("div", { role: "radiogroup", className: (0, import_classnames23.default)("flex", d12), "data-testid": "ratingbutton", ...b8, children: S2.map((e12) => (0, import_jsx_runtime114.jsxs)("label", { onMouseEnter: v6(e12), onMouseLeave: z5, children: [
    (0, import_jsx_runtime114.jsx)(
      "input",
      {
        type: "radio",
    ...
    p10({ isFilled: x6(e12), max: l20, iconSize: L[u9] })
  ] }, e12)) });
}
...
function d10({ totalItems: g7, currentPage: t28 = 1, pageSize: a32 = 10, maxPages: n27 = 1 }) {
  const [e12, c21] = (0, import_react17.useState)((0, import_jw_paginate.default)(g7, t28, a32, n27)), [o35, s10] = (0, import_react17.useState)(t28);
  return (0, import_react17.useEffect)(() => {
    s10(t28);
  }, [t28]), (0, import_react17.useEffect)(() => {
    c21((0, import_jw_paginate.default)(g7, o35, a32, n27));
  }, [g7, o35, a32, n27]), {
    ...
    setPage: (f15) => s10(e12.currentPage = f15)
  };
}
...
var p8 = (0, import_react18.forwardRef)((r13, d12) => {
  const { invalid: a32, className: i15, disabled: e12, ...o35 } = r13;
...
var d11 = (0, import_react19.forwardRef)(
  ({ size: t28 = P.base, invalid: e12 = false, className: i15, ...a32 }, s10) => {
    const { isFocusVisible: o35 } = f12({ isTextInput: true });
      ...
      "textarea",
      {
        ...
        className: (0, import_classnames25.default)([
          "px-4 bg-white rounded-md text-neutral-900 ring-inset hover:ring-primary-800 focus:caret-primary-700 active:caret-primary-700 active:ring-primary-700 active:ring-2 focus:ring-primary-700 focus:ring-2 outline-none",
          {
            ...
            "focus:outline focus:outline-offset": o35
          },
          u8[t28],
          i15
        ]),
...
export {
  ...
  u4 as SfDropdown,
  n2 as SfIconAdd,
  n3 as SfIconAddShoppingCart,
  m4 as SfIconAlokai,
  f3 as SfIconAlokaiFull,
  n4 as SfIconArrowBack,
  l4 as SfIconArrowDownward,
  l5 as SfIconArrowForward,
  p3 as SfIconArrowUpward,
  h4 as SfIconBase,
  i2 as SfIconBlock,
  m5 as SfIconCalendarToday,
  n5 as SfIconCall,
  f4 as SfIconCancel,
  m6 as SfIconCheck,
  m7 as SfIconCheckBox,
  d5 as SfIconCheckBoxOutlineBlank,
  m8 as SfIconCheckCircle,
  l6 as SfIconChevronLeft,
  h5 as SfIconChevronRight,
  m9 as SfIconCircle,
  s as SfIconClose,
  n6 as SfIconCloseSm,
  n7 as SfIconCompareArrows,
  f5 as SfIconContactSupport,
  m10 as SfIconCreditCard,
  n8 as SfIconDelete,
  i3 as SfIconDownload,
  c5 as SfIconEmail,
  c6 as SfIconError,
  i4 as SfIconExpandLess,
  m11 as SfIconExpandMore,
  n9 as SfIconFacebook,
  l7 as SfIconFavorite,
  c7 as SfIconFavoriteFilled,
  v2 as SfIconGridView,
  n10 as SfIconHelp,
  n11 as SfIconHome,
  f6 as SfIconIndeterminateCheckBox,
  l8 as SfIconInfo,
  f7 as SfIconInstagram,
  d6 as SfIconLanguage,
  n12 as SfIconLocalShipping,
  n13 as SfIconLocal_fire_department,
  l9 as SfIconLocationOn,
  ...
  l11 as SfIconLogout,
  c9 as SfIconMenu,
  c10 as SfIconMoreHoriz,
  c11 as SfIconMoreVert,
  c12 as SfIconOpenInNew,
  p4 as SfIconOpenSource,
  i6 as SfIconPackage,
  f8 as SfIconPercent,
  i7 as SfIconPerson,
  c13 as SfIconPinterest,
  n14 as SfIconPublishedWithChanges,
  f9 as SfIconRadioButtonChecked,
  f10 as SfIconRadioButtonUnchecked,
  i8 as SfIconReact,
  c15 as SfIconRemove,
  p5 as SfIconRemoveShoppingCart,
  n15 as SfIconSafetyCheck,
  i9 as SfIconSchedule,
  n16 as SfIconSearch,
  q3 as SfIconSell,
  A4 as SfIconShare,
  e7 as SfIconShoppingCart,
  i10 as SfIconShoppingCartCheckout,
  q as SfIconSize,
  s3 as SfIconSort,
  l12 as SfIconStar,
  m14 as SfIconStarFilled,
  n17 as SfIconStarHalf,
  i11 as SfIconThumbDown,
  n18 as SfIconThumbUp,
  n19 as SfIconTune,
  m15 as SfIconTwitter,
  m16 as SfIconUndo,
  l13 as SfIconUnfoldMore,
  m17 as SfIconUpload,
  n20 as SfIconViewList,
  n21 as SfIconVisibility,
  n22 as SfIconVisibilityOff,
  e8 as SfIconVsfDiamond,
  m18 as SfIconVuejs,
  l14 as SfIconVuestorefront,
  i12 as SfIconWarehouse,
  f11 as SfIconWarning,
  n23 as SfIconYoutube,
  I as SfInput,
  $ as SfInputSize,
  b4 as SfLink,
  R as SfLinkVariant,
  C3 as SfListItem,
  J as SfListItemSize,
  m19 as SfLoaderCircular,
  b6 as SfLoaderLinear,
  e10 as SfLoaderLinearSize,
  Q as SfLoaderSize,
  j3 as SfModal,
  S as SfPopoverPlacement,
  tt as SfPopoverStrategy,
  u5 as SfProgressCircular,
  h7 as SfProgressLinear,
  ...
  h8 as SfTooltip,
  n25 as composeHandlers,
  o31 as createPropsGetter,
  o3 as mergeRefs,
  f as polymorphicForwardRef,
  p7 as useDisclosure,
  C2 as useDropdown,
  f12 as useFocusVisible,
  d10 as usePagination,
  P2 as usePopover,
  z4 as useScrollable,
  F2 as useTooltip,
  z3 as useTrapFocus
